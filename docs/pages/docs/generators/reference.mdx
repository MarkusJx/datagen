...
For example, the [`format` string generator](string.mdx#format) only accepts
strings unless the `serializeNonStrings` option is set to `true`.

## Creating a reference

### Using a [`string`](string.mdx#references) value

A reference may be created using the [`string`](string.mdx) generator
...
For a more complex example, check out the [complex reference example](../../examples/complex-reference.mdx).
...
the current object. The [complex reference example](../../examples/complex-reference.mdx)
...
Check out the [complex reference example](../../examples/complex-reference.mdx) for
