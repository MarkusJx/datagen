...
- `removeNull`: Whether to remove null values from the flattened object or array.
  If not specified, the default is `false`. If set to `false` and a null value is passed, an error will be thrown.
