...
This example schema creates an array of 10 to 100 people with a random number of related persons.
The [`reference`](../docs/generators/reference.mdx) generator is used to create a relationship between two people.

An exception is added to that [`reference`](../docs/generators/reference.mdx) generator in order to prevent a
